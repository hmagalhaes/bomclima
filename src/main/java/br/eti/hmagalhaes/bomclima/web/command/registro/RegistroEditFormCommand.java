...
@ApplicationScoped
public class RegistroEditFormCommand implements ServletCommand {
	...
	@Inject
	public RegistroEditFormCommand(final RegistroDAO registroDAO, final RegistroEditFormModelHelper modelHelper) {
	...
	public void run(final HttpServletRequest request, final HttpServletResponse response)
		...
		logger.info("Dados carregados, direcionando à view => " + ViewMapping.REGISTER_EDIT_FORM);
